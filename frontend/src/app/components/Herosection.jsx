...
const Herosection = () => {
  ...
  const gradientOverlay = "bg-gradient-to-b from-black/80 via-black/65 to-black/80";
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className={`absolute inset-0 ${gradientOverlay} flex flex-col md:flex-row items-center justify-between w-full text-white`}>
        <motion.div 
        ...
        >
          ...
          <motion.p 
            className="text-sm sm:text-base md:text-lg max-w-2xl leading-relaxed text-gray-300"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.4 }}
          >
            At E-Cell, IIIT Ranchi, we foster innovation and entrepreneurial spirit, 
            empowering students to turn their ideas into impactful ventures. Join us 
            to learn, collaborate, and lead the way in building a brighter, innovative future!
          </motion.p>
        </motion.div>
