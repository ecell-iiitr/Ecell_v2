...
function EcellCard() {
  return (
    <div className=" pt-20 px-10  md:pt-28 lg:pt-32 lg:px-32">
      <h1
        className="text-[#BD9F67] text-3xl md:text-6xl font-[400]  text-center"
        style={{
      ...
      <p className="text-sm text-center lg:text-lg mt-10 text-black md:px-10 px-2 font-poppins">
      ...
      <div className="relative w-full h-64 mt-10 rounded-3xl overflow-hidden">
        ...
        <div className="h-full w-full bg-black/50 absolute z-20 top-0 left-0 flex items-center justify-center gap-5">
          <div className="p-2 md:p-10">
            <img
              className="md:h-20 md:w-20 w-10 h-10 mx-auto "
              src="./building.png"
            />
            <h1 className=" text-2xl md:text-4xl text-[#BD9F67] font-extrabold text-center my-2">
              600 +
            </h1>
